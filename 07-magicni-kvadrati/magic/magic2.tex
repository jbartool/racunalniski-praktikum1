...
\begin{figure}[!ht]
   \centering
   \caption{Primer magičnega kvadrata reda 4}
...
\begin{itemize}
   \item %http://mathworld.wolfram.com/MagicSquare.html
   \item %http://en.wikipedia.org/wiki/Magic_square
\end{itemize}
...
\begin{equation}
   \label{eq:mcad} % popravi11
   M_2(n;A,D) = n\frac{1}{2}\bigl(2A+(n^2-1)D\bigr)
\end{equation}
