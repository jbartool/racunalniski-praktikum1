...
\newtheorem{definicija}{Definicija}[section]   % številčenje po sekcijah
...
primer Euler, glej \lbrack3\rbrack. % ključ: euler
...
\begin{equation}
   M_2(n;A,D) = n\left(A+\frac{(n^2-1)}{2}D\right).
\end{equation}% sklic: eq:mc
